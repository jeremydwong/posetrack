...
def run_verification(image_path, output_dir="test/output", device_name="auto",
    ...
    if len(person_boxes_coco) > 0:
        ...
        try:
            ...
            if all_keypoints:
                ...
                # Add more checks if needed (e.g., range checks if points are outside image bounds)
    ...
    # Replicate the visualization from the original test script / pose_detector's main block
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="output/output_verify", help="Directory to save the output annotated image.")
    ...
    run_verification(
        ...
        show_result=not args.hide,
        save_result=not args.no_save
    )

# --- END OF FILE test_verify.py ---