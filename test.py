...
local_model_path = "/Users/jeremy/Git/ProjectKeypointInference/models/synthpose/checkpoints"
device = "mps" if torch.backends.mps.is_available() else "cpu"

# url = "http://farm4.staticflickr.com/3300/3416216247_f9c6dfc939_z.jpg"
# image = Image.open(requests.get(url, stream=True).raw)
image = Image.open("test/image/chanel.png").convert("RGB")
...
### BEG pose_detector.detect_persons
...
### END pose_detector.detect_persons
...
image_processor = AutoProcessor.from_pretrained(local_model_path,local_files_only=True)
...
if __name__ == "__main__":
    ...
    # process_video(
    #     input_video_path=f"/Users/jeremy/Git/ProjectKeypointInference/posetrack/test/caliscope/{testfolder}/{fname}",
    #     output_video_path=f"/Users/jeremy/Git/ProjectKeypointInference/posetrack/output/caliscope/{fname}",
    #     device=device,
