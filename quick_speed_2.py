...
list_dirs = ['/Users/jeremy/Library/CloudStorage/OneDrive-UniversityofCalgary/Project 2025 Older Adult distributed movement assessments/data/2025-08-07/recordings_clara/recording_clara_peakspeed_v2' ,
'/Users/jeremy/Library/CloudStorage/OneDrive-UniversityofCalgary/Project 2025 Older Adult distributed movement assessments/data/2025-08-07/recordings_doreenp/recording_doreenp_peakspeed_v2' ,
'/Users/jeremy/Library/CloudStorage/OneDrive-UniversityofCalgary/Project 2025 Older Adult distributed movement assessments/data/2025-08-07/recordings_lyndar/recording_lyndar_peakspeed_v2' ,
'/Users/jeremy/Library/CloudStorage/OneDrive-UniversityofCalgary/Project 2025 Older Adult distributed movement assessments/data/2025-08-07/recordings_ront/recording_ront_peakspeed_v2' ,
'/Users/jeremy/Library/CloudStorage/OneDrive-UniversityofCalgary/Project 2025 Older Adult distributed movement assessments/data/2025-08-07/recordings_young/recording_young_peakspeed_v2' ]

rotfile = "/Users/jeremy/Library/CloudStorage/OneDrive-UniversityofCalgary/Project 2025 Older Adult distributed movement assessments/data/2025-08-07/recordings/recording_3by1_v4/POSE/xyz_POSE_labelled.csv"
data1 = pd.read_csv(rotfile)
# (data, dat_dict) = pt.map_synthpose_to_mediapipe(data1)
left_heel = np.column_stack([data1['left_heel_x'], 
                            data1['left_heel_y'], 
                            data1['left_heel_z']])
dat_dict = {'left_heel':left_heel}
# rotate matrix
